              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#999]">To: You</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#1A1A1A] rounded-lg p-6 border border-[#2A2A2A]">
                ...
                <div className="space-y-4 text-[#E0E0E0]">
                  ...
                  <p>
                    ...
                    <strong>Database Zero</strong>, has been inactive recently.
                  </p>
                  <p>
                    In our efforts to optimize our services, we will be deleting
                    it soon. If you wish to keep your database, please keep it
                    active by sending it traffic through your apps or upgrade to
                    another plan. We will notify you one more time before
                    deleting. You can always check your database status{" "}
                    <Link
                      href="#"
                  ...
                  <p>
                    Thank you for choosing Upstash. If you need assistance or
                    have any questions, our support team is here to help at{" "}
                    <Link
                      href="#"
                      className="text-blue-400 hover:text-blue-300"
                    >
